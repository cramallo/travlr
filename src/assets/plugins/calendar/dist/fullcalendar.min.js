        ...
        for (s = 0; s < t.length; s++)
          if ((r = z(t[s]))) {
            for (n = _(r), o = 0; o < n.length; o++)
              (a = n[o]),
                a.source ||
                  (e && ($.events.push(a), (a.source = $)), K.push(a));
            l = l.concat(n);
          }
        return l.length && i(), l;
      }
        ...
        renderFillSegEls: function(e, n) {
          ...
          if (n.length) {
            ...
            t(o).each(function(e, i) {
              ...
              s && (l = s.call(r, o, l)),
                l &&
                  ((l = t(l)), l.is(r.fillSegTag) && ((o.el = l), a.push(o)));
            });
          }
          return a;
        },
    ...
    var Ce = (Zt.View = ue.extend({
      ...
      publiclyTrigger: function(t, e) {
        ...
        return n.publiclyTrigger.apply(
          n,
          [t, e || this].concat(Array.prototype.slice.call(arguments, 2), [
            this
          ])
        );
      },
      ...
      Re.mixin({
        ...
        applyTimezone: function(t) {
          ...
          var e,
            ...
            i = t.time() - n.time();
          return (
            i && ((e = n.clone().add(i)), t.time() - e.time() == 0 && (n = e)),
            n
          );
        },
        getNow: function() {
      ...
      Re.mixin({
        ...
        initialRender: function() {
          ...
          n.addClass("fc"),
            ...
            (this.contentEl = t("<div class='fc-view-container'/>").prependTo(
              n
            )),
            this.initToolbars(),
            this.renderHeader(),
